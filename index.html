...
<body>
  ...
  <br />
  <p> <a href=https://www.youtube.com/watch?v=azq0S0DKS50>Millenium Money</a> </p> <hr />
    <p>
      <ul>
        <h2>Bio data </h2>
        <li>Visvesh was born on feb 17 2003 to kavitha and palanivel</li>
        <li>age ; 16 year old</li>
        <li>height ; 5 feet 9 inch </li>
        <li>weight ; 65 kg</li>
        <li>black eyes</li>
        <li>marks;</li>
        <ol>
          <li>mathematics 99</li>
          <li>elglish 99 </li>
          <li> french 99</li>
          <li>tamil 99 </li>
          <li>science 99 </li>
          <li>computer science 99</li>
        </ol>
        <li>fav music : </li>
        <ul>
          <li>juicy ; <a href="https://youtu.be/_JZom_gVfuw">Biggie Smalls</a></li>
          <li>juicy : <a href="https://youtu.be/_JZom_gVfuw">biggie Smalls</a></li>
        </ul>
        </ol>
      </ul>
      
      <a href='contactinfo.html'>contact me here</a>
    </p>
    <hr size="3" />
    <p>
      <h2>MY MEDALS</h2>
      <table border='1'>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              Bronze medal at oour own ienglish school
            </td>
            <td>
              bronze
            </td>
...
<table cellspacing = "20">
  <tr>
    <td>
      <table cellspacing ="20">
        <thead>
          <td><h3>MY SKILLS TO PAY THE BILLS</h3></td>
          <td>MY RATING</td></thead>
        <tbody><td>Sports</td>
          <td>*****</td>
          <tr>
            <td>
